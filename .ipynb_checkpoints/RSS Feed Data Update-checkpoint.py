...
# Filter out words that occur less than 20 (reduced to 5) documents, or more than 50% of the documents.
...
split_df = pd.DataFrame(train_vecs, columns=['Topic '+str(x) for x in range(20)])
